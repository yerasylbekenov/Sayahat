...
class GigaChatClient:
    def __init__(self):
        ...
        self.system_prompt = """
        Вы - ассистент онлайн-платформы Sayahat для покупки туров в Казахстане. Ваша задача - помогать пользователям 
    ...
    def process_message(self, user_id: int, message: str, geo) -> str:
